locals {
  ...
  needed_packages = join(" ", concat(["https://github.com/kube-hetzner/terraform-hcloud-kube-hetzner/raw/fix/k3s-selinux/.extra/k3s-selinux-next.sle.src.rpm restorecond policycoreutils setools-console"], var.packages_to_install))
