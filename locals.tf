locals {
  ...
  autoscaler_count       = sum([for v in var.autoscaler_nodepools : v.max_count])
  is_single_node_cluster = (local.control_plane_count + local.agent_count + local.autoscaler_count) == 1
