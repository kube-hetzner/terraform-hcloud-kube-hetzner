...
2. Either, generate a passphrase-less ed25519 ssh key-pair for your cluster, unless you already have one that you'd like to use. Take note of the respective paths of your private and public keys! Or for a key-pair with passphrase or a device like a Yubikey, make sure you have got an SSH agent running and your key is loaded (`ssh-add -L` to verify) and set `private_key = null`. ✅
