...
echo " "
echo "We advise you to first run 'terraform destroy' and come execute that script when it starts hanging because of ressources still attached to the network."
